...
;;;RETURN VALUE:
(define res (Unitwise::Functional_to_degre self x))

;;;VERIFIED ASSERTION:
(verify #:assume (assert (and )) #:guarantee (assert (unless (stuck? res) (Float_inst_== (Unitwise::Functional_from_degre self res ) x ))))
